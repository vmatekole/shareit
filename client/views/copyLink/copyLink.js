Template.shareit_copyLink.rendered = function() {
  if (!this.data) {
    return;
  }
  return this.autorun(function() {
    ...
    description = ((ref = data.copyLink) != null ? ref.description : void 0) || data.excerpt || data.description || data.summary;
...
Template.shareit_copyLink.helpers(ShareIt.helpers);
